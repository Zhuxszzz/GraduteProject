...
public class GoodsItemRecyclerAdapter extends RecyclerView.Adapter<GoodsItemRecyclerAdapter.ViewHolder> {
    ...
    private List<GoodsCategoryModel> goodscatrgoryEntities;
    private String[] mSectionLetters;
    private List<GoodsItemModel> selectGoods=new ArrayList<>();
    public GoodsItemRecyclerAdapter(Context context, List<GoodsItemModel> items
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        //设置图片
        ImageUtil.load(mContext,dataList.get(position).getGoodsImgUrl(),holder.ivGoodsImage,ImageUtil.INSTANCE.getREQUEST_OPTIONS());
            ...
            public void onClick(View v) {
                if (goodsNum[position] > 0) {
                    ...
                    if (mGoodsCategoryBuyNums[dataList.get(position).getId()] == 0){
                        DataSupport.deleteAll(GoodsBuyCategoryNum.class,"resId = ? and categoryId = ?",
                    ...
                    if (goodsNum[position] == 0){
                        DataSupport.deleteAll(GoodsBuyItemNum.class,"resId = ? and categoryId = ? and goodId = ?",
